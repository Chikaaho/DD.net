...
//        String salt = new SecureRandomNumberGenerator().nextBytes().toHex();
        ...
        SimpleHash simpleHash = new SimpleHash(hashAlgorithmName
                ,originalPassword,
                ByteSource.Util.bytes("shirotest"),
                hashIterations);
        String encryptionPassword = simpleHash.toBase64();

        //创建用户信息
        Student studentInfo = new Student();
        studentInfo.setUsername("shirotest");
        studentInfo.setPassword(encryptionPassword);
       ...
       // userInfo.setState(2);
        ...
        //执行新增
        studentMapper.insertStudent(studentInfo.getUsername(),studentInfo.getPassword(),18240381
                ,"软件1");
